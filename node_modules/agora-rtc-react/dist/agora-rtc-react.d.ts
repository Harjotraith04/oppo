import { IExtension, IAudioProcessor, IBaseProcessor } from 'agora-rte-extension';
 ...
 * ```
 */
declare function useLocalCameraTrack(ready?: boolean, cameraVideoTrackConfig?: CameraVideoTrackInitConfig, client?: IAgoraRTCClient): {
 ...
 * ```
 */
declare function useLocalScreenTrack(ready: boolean, screenVideoTrackInitConfig: ScreenVideoTrackInitConfig, withAudio: "enable", client?: IAgoraRTCClient): {
    screenTrack: [ILocalVideoTrack, ILocalAudioTrack] | null;
    isLoading: boolean;
    error: AgoraRTCReactError | null;
};
declare function useLocalScreenTrack(ready: boolean, screenVideoTrackInitConfig: ScreenVideoTrackInitConfig, withAudio: "disable", client?: IAgoraRTCClient): {
    screenTrack: ILocalVideoTrack | null;
    isLoading: boolean;
    error: AgoraRTCReactError | null;
};
declare function useLocalScreenTrack(ready: boolean, screenVideoTrackInitConfig: ScreenVideoTrackInitConfig, withAudio: "auto", client?: IAgoraRTCClient): {
